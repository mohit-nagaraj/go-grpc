...
func (c *greetServiceClient) SayHelloStream(ctx context.Context, in *NamesList, opts ...grpc.CallOption) (GreetService_SayHelloStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[0], "/greet_service.GreetService/SayHelloStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *greetServiceSayHelloStreamClient) Recv() (*HelloResponse, error) {
	m := new(HelloResponse)
...
func (UnimplementedGreetServiceServer) SayHelloStream(*NamesList, GreetService_SayHelloStreamServer) error {
...
func (x *greetServiceSayHelloStreamServer) Send(m *HelloResponse) error {
